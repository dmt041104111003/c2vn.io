      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
        ...
        <div className="relative w-full self-start" ref={dropdownRef}>
          <select
            ...
            className="w-full pr-4 py-2 border border-gray-300 dark:border-white/20 rounded-sm bg-white dark:bg-gray-800/50 backdrop-blur-sm text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
            title="Select tags"
          >
