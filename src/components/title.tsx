    ...
    <div className="relative mb-16">
      <div className="mb-6 flex items-center gap-4">
        ...
        <div className="relative group">
          ...
          <div
            role="tooltip"
            className="pointer-events-none absolute left-0 top-full mt-2 hidden max-w-[80vw] rounded-md border border-gray-200 bg-white p-3 text-sm text-gray-700 shadow-lg group-hover:block dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200"
          >
            {description}
          </div>
        </div>
      ...
      <div className="relative group max-w-3xl">
        ...
        {truncated !== description && (
          <div
            role="tooltip"
            className="pointer-events-none absolute left-0 top-full mt-2 hidden max-w-[90vw] rounded-md border border-gray-200 bg-white p-3 text-sm text-gray-700 shadow-lg group-hover:block dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200"
          >
            {description}
          </div>
        )}
